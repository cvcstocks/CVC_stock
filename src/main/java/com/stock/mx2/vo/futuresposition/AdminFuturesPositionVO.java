...
public class AdminFuturesPositionVO {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AdminFuturesPositionVO)) return false;
        AdminFuturesPositionVO other = (AdminFuturesPositionVO) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof AdminFuturesPositionVO;
    }
