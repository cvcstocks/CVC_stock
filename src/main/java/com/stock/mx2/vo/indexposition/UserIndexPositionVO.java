...
public class UserIndexPositionVO {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserIndexPositionVO)) return false;
        UserIndexPositionVO other = (UserIndexPositionVO) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof UserIndexPositionVO;
    }
