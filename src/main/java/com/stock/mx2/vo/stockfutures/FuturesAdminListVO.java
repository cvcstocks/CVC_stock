...
package com.stock.mx2.vo.stockfutures;
...
public class FuturesAdminListVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FuturesAdminListVO)) return false;
        FuturesAdminListVO other = (FuturesAdminListVO) o;
        ...
        if ((this$now_price == null) ? (other$now_price != null) : !this$now_price.equals(other$now_price))
            return false;
        Object this$last_close = getLast_close(), other$last_close = other.getLast_close();
        if ((this$last_close == null) ? (other$last_close != null) : !this$last_close.equals(other$last_close))
            return false;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof FuturesAdminListVO;
    }
