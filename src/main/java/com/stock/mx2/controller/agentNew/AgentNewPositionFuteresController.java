...
@Controller
@RequestMapping({"/agentNew/futures/position/"})
public class AgentNewPositionFuteresController extends AgentBaseController{
    private static final Logger log = LoggerFactory.getLogger(AgentNewPositionFuteresController.class);

    @Autowired
    IUserFuturesPositionService iUserPositionService;
