...
public class AdminPositionFuturesController {
    private static final Logger log = LoggerFactory.getLogger(AdminPositionFuturesController.class);
    ...
    public ServerResponse sell(String positionSn) throws Exception {
        ...
        try {
            serverResponse = this.iUserPositionService.sell(positionSn, 0,0);
        } catch (Exception e) {
